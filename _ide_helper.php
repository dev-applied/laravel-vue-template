...
namespace Illuminate\Support\Facades {
     ...
     */        class Route {
         ...
         * 
         *
         * @see \Rickycezar\Impersonate\ImpersonateServiceProvider::registerRoutesMacro()
         * @static 
...
namespace Illuminate\Database\Eloquent\Relations {
     ...
     */        class Relation {
         ...
         * 
         *
         * @see \App\Mixins\HasManyMixin::syncWithoutDetaching()
         * @param mixed $data
         * @return array 
         * @static 
         */        public static function syncWithoutDetaching($data)
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::syncWithoutDetaching($data);
        }
                    /**
         * 
         *
         * @see \App\Mixins\HasManyMixin::sync()
         * @param mixed $data
         * @param mixed $deleting
         * @return array 
         * @static 
         */        public static function sync($data, $deleting = true)
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::sync($data, $deleting);
        }
                    /**
         * 
         *
         * @see \App\Mixins\HasManyMixin::castKeys()
         * @param array $keys
         * @return array 
         * @static 
         */        public static function castKeys($keys)
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::castKeys($keys);
        }
                    /**
         * 
         *
         * @see \App\Mixins\HasManyMixin::castKey()
         * @param string|int $key
         * @return string|int 
         * @static 
         */        public static function castKey($key)
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::castKey($key);
        }
                    /**
         * 
         *
         * @see \App\Mixins\VuetifyPaginateMixin::vuetifyPaginate()
         * @return \Illuminate\Pagination\LengthAwarePaginator 
         * @static 
         */        public static function vuetifyPaginate()
        {
                        return \Illuminate\Database\Eloquent\Relations\Relation::vuetifyPaginate();
        }
            }
    }
...
namespace Illuminate\Database\Schema {
     ...
     */        class Blueprint {
         ...
         * 
         *
         * @see \App\Mixins\WhoDidItMixin::whoDidIt()
         * @static 
         */        public static function whoDidIt()
        {
                        return \Illuminate\Database\Schema\Blueprint::whoDidIt();
        }
            }
    }
...
namespace  {
             ...
             */            public static function vuetifyPaginate()
            {
                                return \Illuminate\Database\Eloquent\Builder::vuetifyPaginate();
            }
                            /**
