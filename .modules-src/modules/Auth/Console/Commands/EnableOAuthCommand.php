...
class EnableOAuthCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        warning('Deploy gotcha: a recursive setfacl over storage/ forces the ACL mask to rwx, so a 600 oauth-private.key reads as 0670 and league/oauth2-server rejects it (OAuth endpoints 500 after deploy, fine locally). Fixed in dev-applied/deploy-action; using the env vars above avoids it entirely.');
