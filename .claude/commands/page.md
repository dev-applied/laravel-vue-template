...
1. Run `docker compose exec $DOCKER_ROUTER php artisan vue:make-page` and pass `$ARGUMENTS` as the page name. This writes `resources/ts/pages/$ARGUMENTS.vue` from `stubs/vue-make-page.stub`.
