...
// Re-exported, not redeclared. There used to be a second NotificationItem
// defined here, and it drifted from the composable's: `id` was string|number
// against string, and `body` rejected the null the API actually sends. The two
// were structurally incompatible, so wiring the composable's data into this
// component could not type-check in either direction.
